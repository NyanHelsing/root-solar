...
export const BeingLogin = ({
    ...
    const [status, setStatus] = useState<LoginStatus>(sessionRecord ? "sessionReady" : "idle");
        ...
        <FlareStack gap="lg">
            ...
            >
                <FlareStack gap="sm" align="center">
                    <span className="rs-text-soft">
                        {dragActive
                            ? "Release to load credential"
                            : "Drag & drop credential JSON or click to browse"}
                    </span>
                    <FlareButton
                        type="button"
                        variant="ghost"
            ...
            {credentialSummary ? (
                <FlareStack gap="sm">
                    ...
                    <p className="rs-text-soft">
                        Loaded {credentialFileName ?? "credential"} for being{" "}
                        <strong>{credentialSummary.name ?? credentialSummary.id}</strong>.
                    </p>
            ...
            {sessionSummary ? (
                ...
                >
                    ...
                    <p>
                        Keys for <strong>{sessionSummary.beingName}</strong> are available in this
                        browser.
                    </p>
                    {sessionSummary.pin ? (
                        <>
                            <p>
                                This PIN is randomly generated for this session. Use it to approve
                                sensitive actions while you stay signed in:
                            </p>
                            <div
                                style={{
                                    fontSize: "2.5rem",
                            ...
                            <p className="rs-text-soft">
                                We only store your decrypted keys in memory. If you forget the PIN,
                                drop your credential file to create a new session and receive a
                                fresh PIN.
                            </p>
                        </>
                    ) : (
                        <p className="rs-text-soft">
                            Use the 4-digit session PIN you saved earlier. If it is misplaced,
                            re-import your credential file to establish a new session.
                        </p>
                    )}

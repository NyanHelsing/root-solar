...
export type BeingSessionAction = { type: "set"; record: BeingSessionRecord } | { type: "clear" };

export const beingSessionAtom = atom<BeingSessionRecord | null, [BeingSessionAction], void>(

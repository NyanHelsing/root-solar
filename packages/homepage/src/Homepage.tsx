...
import { FlareButton, FlareCard, FlareList, FlarePageSection, FlareStack } from "@root-solar/flare";
import {
    RootSolarHero,
    ShellLayout,
        ...
        <RootSolarHero
            ...
            actions={
                <FlareStack direction="row" gap="sm" wrap>
                    ...
                    <FlareButton variant="ghost" onClick={() => navigate("/auth")}>
                        See the ledger
                    </FlareButton>
                </FlareStack>
            }
        ...
        <FlareStack gap="lg">
            <FlareStack gap="sm">
                ...
                <p className="rs-text-body-lg rs-text-soft">
                    root.solar exists because we are tired of watching thoughtful beings burn out
                    while rushed choices set the tone for entire ecosystems. By writing our
                    operating principles into a shared canon, nobody has to wonder if the next
        ...
        <FlareStack gap="lg">
            <FlareStack gap="sm">
                ...
                <p className="rs-text-soft">
                    The platform is simple on purpose: every interaction is designed to reduce
                    cognitive load while amplifying shared intent.
                </p>
            </FlareStack>
            <FlareList
        ...
        <FlarePageSection paddingBlock="4rem">
            <FlareStack gap="md" align="center">
                ...
                <p className="rs-text-soft" style={{ maxWidth: "48ch", textAlign: "center" }}>
                    Spend ten focused minutes capturing what you refuse to compromise on. Future
                    decisions—yours and ours—will thank you.
                </p>
    ...
    <FlarePageSection paddingBlock="2rem">
        <FlareStack gap="sm" align="center">
            <p className="rs-text-soft" style={{ textAlign: "center", maxWidth: "52ch" }}>
                Every principle committed to root.solar is a signal that we intend to steward life
                together rather than manage it alone.
            </p>
        </FlareStack>
    </FlarePageSection>
);

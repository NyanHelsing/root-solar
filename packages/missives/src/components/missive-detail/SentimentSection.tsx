    ...
    <FlareStack gap="md">
      ...
      {sentiments.length > 0 ? (
                ...
                <FlareStack gap="md">
                  ...
                  <FlareStack direction="row" align="center" gap="sm" wrap>
                    <FlareIconButton
                      ...
                      variant="solid"
                      onClick={() => {
                        const next = clampWeightForTag(sentiment.tagId, resolvedWeight + 1);
                  ...
                  <span className="rs-text-caption rs-text-soft">
                    {sentiment.totalWeightForTag ?? 0} total points across {displayLabel}.
                  </span>
                </FlareStack>
              </FlareCard>
            ),
        ...
        <p className="rs-text-soft">
          No sentiments recorded yet. Use the form below to capture how this {labels.singular}
          resonates.
        </p>
      )}

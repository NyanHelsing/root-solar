...
const stripTagPrefix = (value: string) => (value.startsWith("tag:") ? value.slice(4) : value);
...
export const addActiveMissiveTagAtom = atom(null, async (get, set, tagInput: string) => {

...
import type { SentimentAllocation, SentimentModel } from "../persistence/entities/index.ts";
...
const normaliseFraction = (numerator: number, denominator: number): SentimentFraction => {
    if (numerator <= 0) {

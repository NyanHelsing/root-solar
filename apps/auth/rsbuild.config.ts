...
const authDistSubdir = resolveDistSubdir(process.env.AUTH_DIST_SUBDIR, DEFAULT_AUTH_DIST_SUBDIR);
const authMountPath = resolveMountPath(process.env.AUTH_REMOTE_PATH, DEFAULT_AUTH_MOUNT);
const authAssetPrefix = resolveAssetPrefix(process.env.AUTH_ASSET_PREFIX, authMountPath);

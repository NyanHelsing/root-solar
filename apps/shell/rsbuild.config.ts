...
const shellAssetPrefix = resolveAssetPrefix(process.env.SHELL_ASSET_PREFIX, shellMountPath);
...
const authRemoteBase = resolveBaseUrl(process.env.AUTH_REMOTE_URL, authMountPath);

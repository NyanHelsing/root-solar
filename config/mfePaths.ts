...
export const resolveMountPath = (value: string | undefined, fallback: string) => {
    if (!value) {
        return fallback;
    }
...
export const resolveBaseUrl = (value: string | undefined, fallback: string) => {
    if (!value) {
        return fallback;
    }
...
export const resolveAssetPrefix = (value: string | undefined, fallback: string) => {
...
export const resolveDistSubdir = (value: string | undefined, fallback: string) => {
    if (!value) {
        return fallback;
    }
